...
![PROFIsafe](../../../_assets/safetyio_profisafe/profisafe_param.png)
...
![PROFIsafe](../../../_assets/safetyio_profisafe/profisafe_connect.png)
...
![PROFIsafe](../../../_assets/safetyio_profisafe/EC_master_setting1.png)
<br> <br>
![PROFIsafe](../../../_assets/safetyio_profisafe/EC_master_setting2.png)
...
![PROFIsafe](../../../_assets/safetyio_profisafe/profisafe_gsdmal.png)

### 4.3 PROFIsafe 컨트롤러 설정 (TIA Portal)
#### 4.3.1 PROFINET 설정
1) TIA Portal을 실행시키고 새 프로젝트를 생성한다.
2) Device & Network 부분을 더블클릭하여 오픈한다.<br>
![PROFIsafe](../../../_assets/safetyio_profisafe/profisafe_device_network.png)
...
![PROFIsafe](../../../_assets/safetyio_profisafe/profisafe_device_network2.png)
...
![PROFIsafe](../../../_assets/safetyio_profisafe/profisafe_device_network3.png)
...
![PROFIsafe](../../../_assets/safetyio_profisafe/profisafe_device_network4.png)
...
- (IP주소는 변경 필요 없음.)
2) "적용" 버튼을 누른다.<br>
![PROFIsafe](../../../_assets/safetyio_profisafe/4_1_profinet_config.png)

#### 4.4.2 PROFIsafe 설정

1) 이전장에서 설정했던 똑같은 값으로 Target Address를 1로 설정한다.
2) "적용" 버튼을 누른다.<br>
![PROFIsafe](../../../_assets/safetyio_profisafe/4_2_profisafe_config.png)

### 4.5 PROFINET과 PROFIsafe 통신의 확인

### 4.5.1 안전 래더 프로그램 (Tia Portal)
1) Device Overview 탭 에서, 아래와 같이 래더 프로그램을 만들고 컨트롤러로 다운로드 한다.<br>
![래더 프로그램](../../../_assets/safetyio_profisafe/5_1_Safety_Ladder.png)
2) 다운로드 후, Distribution I/O 화면에서 녹색 체크 박스가 표시되었는지 확인한다.<br>
![래더 프로그램](../../../_assets/safetyio_profisafe/5_1_Safety_Ladder2.png)

### 4.5.2 TP 화면
1) PROFINET
메뉴에서 시스템 -> 안전시스템 -> 모니터링 -> PROFINET 상태로 이동한다.<br>
![PROFIsafe](../../../_assets/safetyio_profisafe/5_2_pnio_status.png)
- 각 슬롯의 상태 정보를 확인
...
![PROFIsafe](../../../_assets/safetyio_profisafe/6_3_public_io.png)
