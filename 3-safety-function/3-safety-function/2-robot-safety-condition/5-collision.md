...
*\[System > 4: Application Parameters > 18: SafeSpace2.0 > 1: Safety Function > Parameter Settings > Robot Limit > Collision Detection]** menu allows you to set the parameter values.

![!Collision Detection Setting Screen](../../../_assets/col-det.png)

| **| Parameter | 　　　　　　　　　Description                                                  |  Default Setting |** | 　　　　　　　　　**| Parameter | 　　　　　　　　　Description                                                  |  Default Setting |**                                                  |  **| Parameter | 　　　　　　　　　Description                                                  |  Default Setting |** |
| :------: | ---------------------------------------------------------------- | :---------: |
